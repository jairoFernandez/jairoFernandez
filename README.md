...
* [nevalang/neva](https://github.com/nevalang/neva) from [@nevalang](https://github.com/nevalang) with 481 ⭐️
* [browser-use/web-ui](https://github.com/browser-use/web-ui) from [@browser-use](https://github.com/browser-use) with 4.10K ⭐️
...
* [kelseyhightower/kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) from [@kelseyhightower](https://github.com/kelseyhightower) with 42K ⭐️
...
<sup><sub>Last updated: February 01, 2025 at 03:06:26 EST. The content here updates twice daily or when manually triggered.</sup></sub>